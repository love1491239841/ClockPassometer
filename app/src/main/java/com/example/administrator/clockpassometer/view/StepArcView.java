package com.example.administrator.clockpassometer.view;
...
public class StepArcView extends View {
    ...
    private void drawArcYellow(Canvas canvas, RectF rectF) {
        ...
        /** 默认画笔颜色，黄色 */
        paint.setColor(Color.parseColor("#248888"));
        /** 结合处为圆弧*/
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(Color.parseColor("#d81e06"));//设置画笔颜色
    ...
    private void drawTextNumber(Canvas canvas, float centerX) {
        ...
        vTextPaint.setColor(Color.parseColor("#d81e06"));
    ...
    private void drawTextStepString(Canvas canvas, float centerX) {
        ...
        vTextPaint.setTextAlign(Paint.Align.CENTER);
        vTextPaint.setAntiAlias(true);//抗锯齿功能
        vTextPaint.setColor(Color.parseColor("#707070"));
